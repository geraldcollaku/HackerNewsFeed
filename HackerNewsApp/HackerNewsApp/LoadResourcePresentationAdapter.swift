...
extension AsyncLoadResourcePresentationAdapter: FeedStoryCellControllerDelegate {
...
extension LoadResourcePresentationAdapter: FeedStoryCellControllerDelegate {
    func didRequestStory() {
        loadResource()
    }
